...
for emotion in emotions:
    ...
    print("\n")
    print("=" * 60)
    print("Learning PATCH LAT directions for:", emotion)
    print("=" * 60)
    ...
    for layer in range(12):
        ...
        # Mean of training difference vectors
    ...
    print(
        f"Saved PATCH LAT directions for {emotion}."
    )


print("\n")
print("=" * 60)
print("FINISHED PATCH LAT FOR ALL EMOTIONS")
print("=" * 60)